      ...
      <div className="overview">
        ...
        <li>
          ...
          <p className="data-info">
            ...
            they play. The chart can be used as a tool to help decide whom
            should be getting more or less playing time based off of their
        ...
        <li>
          ...
          <p className="data-info">
            Select different teams to find their superstars! Click on the
            player's names to see their individualized minute stats mulitipled
            by 48.
          </p>
        </li>
      </div>
